...
pub mod security_policies {
    ...
    pub const AES128_SHA256_RSA_OAEP: &str = "http://opcfoundation.org/UA/SecurityPolicy#Aes128_Sha256_RsaOaep";
    pub const AES256_SHA256_RSA_PSS: &str = "http://opcfoundation.org/UA/SecurityPolicy#Aes256_Sha256_RsaPss";
}
